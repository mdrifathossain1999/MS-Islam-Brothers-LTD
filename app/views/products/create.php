...
<div class="form-card">
    <h4 class="mb-4" style="color: var(--text-primary);"><i class="bi bi-plus-circle me-2"></i>Add New Product</h4>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="barcode" id="barcodeInput" placeholder="Barcode or SKU">
                                <button type="button" class="btn btn-outline-primary" onclick="generateBarcode()" title="Generate Barcode">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="sell_price" step="0.01" min="0" required placeholder="0.00">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="low_stock_threshold" min="0" value="10" placeholder="10">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="image-upload" onclick="document.getElementById('productImage').click()">
                        ...
                        <p class="mb-0 text-muted"><i class="bi bi-cloud-arrow-up me-1"></i>Click to upload image</p>
