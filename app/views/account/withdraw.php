...
<div class="page-header">
    <h1><i class="bi bi-arrow-up-circle me-2"></i>Withdraw Money</h1>
</div>

<div class="row">
    <div class="col-md-4">
        <div class="card-modern">
            <div class="card-header-modern"><h5>New Withdrawal</h5></div>
            <div class="p-4">
                <form method="POST">
                    ...
                    <button type="submit" class="btn-primary w-100">Withdraw</button>
                </form>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    <?php if (!empty($transactions)): ?>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-withdraw">-<?php echo DEFAULT_CURRENCY . number_format($t['amount'], 2); ?></span></td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="5" class="text-center py-4">No withdrawals yet</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
