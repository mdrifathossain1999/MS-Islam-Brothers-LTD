...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1><i class="bi bi-calendar-month"></i> Monthly Sales Report</h1>
            <p><?= $monthName; ?></p>
        </div>
        <div class="d-flex gap-3 align-items-center flex-wrap">
            <form method="GET" class="d-flex gap-2">
                ...
                <select class="form-select" name="month">
                    <?php for ($m = 1; $m <= 12; $m++): ?>
                    <option value="<?= str_pad($m, 2, '0', STR_PAD_LEFT); ?>" <?= $m == $month ? 'selected' : ''; ?>><?= date('F', strtotime("2024-$m-01")); ?></option>
                    <?php endfor; ?>
                </select>
            ...
            <div class="export-dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="<?= BASE_URL; ?>/report/monthly?year=<?= $year; ?>&month=<?= str_pad($month, 2, '0', STR_PAD_LEFT); ?>&export=csv">
...
<div class="card-modern">
    <div class="card-header">
        <h5><i class="bi bi-list-ul"></i> Monthly Sales Details</h5>
    </div>
